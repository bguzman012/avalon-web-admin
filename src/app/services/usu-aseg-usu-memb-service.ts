...
export class UsuarioAseguradorUsuarioMembresiasService {
  ...
  async guardarUsuAsegUsuMemb(usuAsegUsuMembData: any): Promise<any> {
    try {
      const response = await this.http.post<any>(`${this.apiUrl}/usuAseguradorasUsuMembresias`, usuAsegUsuMembData).toPromise();
      return response;
    } catch (error) {
