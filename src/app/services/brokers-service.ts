...
export class BrokersService {
  ...
  async obtenerBrokersByEstado(
    ...
    try {
      ...
      const brokers = await this.http.get<any[]>(`${this.apiUrl}/brokers?estado=${estado}&page=${page}&size=${size}&busqueda=${busqueda}${sort}`).toPromise();
