...
import { CasosReportesComponent } from './casos-reportes.component';

describe('AseguradorasComponent', () => {
  let component: CasosReportesComponent;
  let fixture: ComponentFixture<CasosReportesComponent>;
  let iconSetService: IconSetService;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CasosReportesComponent],
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CasosReportesComponent);
