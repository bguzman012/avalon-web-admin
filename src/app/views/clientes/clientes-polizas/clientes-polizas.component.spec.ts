...
import { ClientesPolizasComponent } from './clientes-polizas.component';

describe('ClientesPolizasComponent', () => {
  let component: ClientesPolizasComponent;
  let fixture: ComponentFixture<ClientesPolizasComponent>;
  let iconSetService: IconSetService;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ClientesPolizasComponent],
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ClientesPolizasComponent);
